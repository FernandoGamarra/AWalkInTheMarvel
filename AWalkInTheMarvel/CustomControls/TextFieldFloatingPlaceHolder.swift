//
//  TextFieldFloatingPlaceHolder.swift
//  From: https://github.com/Skyscanner/SkyFloatingLabelTextField
//
//  Created by Fernando Gamarra on 22/06/2020.
//  Copyright © 2020 FringeFan. All rights reserved.
//
 ...
 */
@IBDesignable
open class TextFieldFloatingPlaceHolder: UITextField { // swiftlint:disable:this type_body_length
    /**
...
//        }
    ...
    */
    ...
    fileprivate func addEditingChangedObserver() {
        self.addTarget(self, action: #selector(TextFieldFloatingPlaceHolder.editingChanged), for: .editingChanged)
    }
